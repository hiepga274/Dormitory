...
(function () {
    ...
    abp.message.confirm = function (message, title, callback, options) {
        ...
        options.confirmButtonText = options.confirmButtonText || abp.localization.abpWeb('Đồng ý');
        options.cancelButtonText = options.cancelButtonText || abp.localization.abpWeb('Đóng');
