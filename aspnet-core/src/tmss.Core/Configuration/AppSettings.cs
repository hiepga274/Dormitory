namespace tmss.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        public static class FbLead
        {
            public const string AppId = "FbLead.AppId";
            public const string AppSecret = "FbLead.AppSecret";
            public const string VerifyToken = "FbLead.VerifyToken";
            public const string CallbackUrl = "FbLead.CallbackUrl";
        }
    }
}