    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[] {
                ...
                new SettingDefinition(AppSettings.FbLead.AppId, GetFromSettings("FbLead:AppId", string.Empty), isVisibleToClients: true),
                new SettingDefinition(AppSettings.FbLead.AppSecret, GetFromSettings("FbLead:AppSecret", string.Empty), isVisibleToClients: false),
                new SettingDefinition(AppSettings.FbLead.VerifyToken, GetFromSettings("FbLead:VerifyToken", string.Empty), isVisibleToClients: false),
                new SettingDefinition(AppSettings.FbLead.CallbackUrl, GetFromSettings("FbLead:CallbackUrl", string.Empty), isVisibleToClients: false),
            };
        }
